...
# 2 - Email sent message                        // PasswordResetDoneView.as_view()      // name='reset_password_done'
# 3 - Email with link and reset instructions    // PasswordResetConfirmView.as_view()   // name=''reset_password_confirm'
# 4 - Password successfully reset message       // PasswordResetCompleteView.as_view()  // name='reset_password_complete'